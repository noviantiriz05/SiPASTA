        ...
        <tbody>
            ...
            if ($katakunci != '') {
                ...
                for ($x = 0; $x < count($array_katakunci); $x++) {
                    $sqlcari[] = "(perihal like '%" . $array_katakunci[$x] . "%' or pengirim like '%" . $array_katakunci[$x] . "%' or penerima like '%" . $array_katakunci[$x] . "%' or jsurat like '%" . $array_katakunci[$x] . "%' or isi like '%" . $array_katakunci[$x] . "%')";
                }
