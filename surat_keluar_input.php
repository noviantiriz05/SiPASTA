...
<div class="container mt-4">
    ...
    if (isset($_POST['simpan'])) {
        ...
        if (empty($error)) {
            if ($id != "") {
                $sql1 = "update surat_keluar set perihal = '$perihal', pengirim = '$pengirim', penerima = '$penerima', jsurat = '$jsurat', isi = '$isi', tgl_isi = now() where id = '$id'";
            } else {
                $sql1 = "insert into surat_keluar(perihal, pengirim, penerima, jsurat, isi) values ('$perihal','$pengirim','$penerima','$jsurat','$isi')";
            }
