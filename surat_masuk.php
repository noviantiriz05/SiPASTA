...
<div class="container mt-4">
    ...
    <form class="row g-3" method="get">
        ...
        <div class="col-auto">
            <input type="submit" name="cari" value="Cari Tulisan" class="btn btn-secondary btn-sm" />
        </div>
    </form>
    <table class="table table-striped">
        ...
        <tbody>
            ...
            $sql1 = "select * from surat_masuk $sqltambahan";
            ...
            while ($r1 = mysqli_fetch_array($q1)) {
                ...
                <tr>
                    ...
                    <td>
                        <?php if (isset($_SESSION['members_email'])): ?>
                            <a href="surat_masuk_detail.php?id=<?php echo $r1['id'] ?>">
                                <span class="badge text-bg-info">Lihat</span>
                            </a>
                        <?php endif; ?>
                        <?php if (isset($_SESSION['members_email'])): ?>
                            <a href="surat_masuk_input.php?id=<?php echo $r1['id'] ?>">
                                <span class="badge text-bg-warning">Edit</span>
                            </a>
                        <?php endif; ?>
                        <?php if (isset($_SESSION['members_email'])): ?>
                            <a href="surat_masuk.php?op=delete&id=<?php echo $r1['id'] ?>"
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination">
            ...
            for ($i = 1; $i <= $pages; $i++) {
                ...
                <li class="page-item">
                    <a class="page-link"
                        href="surat_masuk.php?katakunci=<?php echo $katakunci ?>&cari=<?php echo $cari ?>&page=<?php echo $i ?>"><?php echo $i ?></a>
                </li>
                <?php
            }
            ?>
